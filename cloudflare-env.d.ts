/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare-env.d.ts --env-interface CloudflareEnv` (hash: 9737decc9bb002a5da726db20c4a9558)
...
interface __BaseEnv_CloudflareEnv {
	...
	DATABASE_URL: string;
	WORKER_SELF_REFERENCE: Fetcher /* firstai-booking */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "DATABASE_URL">> {}
}
